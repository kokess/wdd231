...
// -----------------------------------------------
const WEATHER_API_KEY = "YOUR_API_KEY_HERE";  // ← replace with your OpenWeatherMap key
const CITY = "Timbuktu";
const COUNTRY_CODE = "ML";                   // Mali ISO code
...
async function getWeatherForecast() {
    try {
        ...
        days.forEach(([dayName, item]) => {
            ...
            tempSpan.textContent = `${Math.round(item.main.temp)}°F`;
